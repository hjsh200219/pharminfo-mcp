...
# --- Helpers for non-GET requests ---

def _request_with_body(method: str, url: str, body: Optional[Dict[str, Any]], timeout: int, content_type: str = "application/json") -> requests.Response:
    headers = _headers()
    if content_type == "multipart/form-data":
        files = {k: (None, (v if isinstance(v, str) else str(v))) for k, v in (body or {}).items()}
        return requests.request(method, url, headers=headers, files=files, timeout=timeout)
    if content_type == "application/x-www-form-urlencoded":
        headers["Content-Type"] = content_type
        return requests.request(method, url, headers=headers, data=(body or {}), timeout=timeout)
    headers["Content-Type"] = content_type
    return requests.request(method, url, headers=headers, json=(body or {}), timeout=timeout)


def _put_or_patch(url: str, body: Optional[Dict[str, Any]], timeout: int, content_type: str = "application/json") -> Dict[str, Any]:
    resp = _request_with_body("PUT", url, body, timeout, content_type)
    if resp.status_code // 100 == 2:
        return _handle_response(resp)
    if resp.status_code in (400, 404, 405, 415):
        resp2 = _request_with_body("PATCH", url, body, timeout, content_type)
        return _handle_response(resp2)
    return _handle_response(resp)


# --- Non-GET endpoints (Swagger) ---

# DrugEffect

def create_drug_effect(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/drug-effect"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)


def merge_drug_effect(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/drug-effect/merge"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)


def update_drug_effect(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/drug-effect"
    return _put_or_patch(url, body, timeout, content_type)


def delete_drug_effect(effect_id: int, timeout: int = 15) -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/drug-effect/{int(effect_id)}"
...
def create_drug_kind(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/drug-kind"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)
...
def merge_drug_kind(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/drug-kind/merge"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)


def update_drug_kind(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/drug-kind"
    return _put_or_patch(url, body, timeout, content_type)


def delete_drug_kind(effect_id: int, timeout: int = 15) -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/drug-kind/{int(effect_id)}"
    resp = requests.delete(url, headers=_headers(), timeout=timeout)
    return _handle_response(resp)
...
def create_guide_a4(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/guide-a4"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)
...
def merge_guide_a4(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/guide-a4/merge"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)


def update_guide_a4(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/guide-a4"
    return _put_or_patch(url, body, timeout, content_type)


def delete_guide_a4(guide_id: int, timeout: int = 15) -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/guide-a4/{int(guide_id)}"
    resp = requests.delete(url, headers=_headers(), timeout=timeout)
    return _handle_response(resp)
...
def create_guide_a5(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/guide-A5"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)
...
def merge_guide_a5(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/guide-A5/merge"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)


def update_guide_a5(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/guide-A5"
    return _put_or_patch(url, body, timeout, content_type)


def delete_guide_a5(guide_id: int, timeout: int = 15) -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/guide-A5/{int(guide_id)}"
    resp = requests.delete(url, headers=_headers(), timeout=timeout)
    return _handle_response(resp)
...
def create_main_ingredient(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)
...
def bulk_main_ingredient(code: str, body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/{code}/bulk"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)


def update_main_ingredient(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient"
    return _put_or_patch(url, body, timeout, content_type)


def delete_main_ingredient(code: str, timeout: int = 15) -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/{code}"
    resp = requests.delete(url, headers=_headers(), timeout=timeout)
    return _handle_response(resp)
...
def delete_main_ingredient_cache(code: str, timeout: int = 15) -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/{code}/cache"
    resp = requests.delete(url, headers=_headers(), timeout=timeout)
    return _handle_response(resp)
...
def update_main_ingredient_picto(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/main-ingredient/picto"
    return _put_or_patch(url, body, timeout, content_type)
...
def create_product(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/product"
    resp = _request_with_body("POST", url, body, timeout, content_type)
    return _handle_response(resp)
...
def update_product(body: Dict[str, Any], timeout: int = 15, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/product"
    return _put_or_patch(url, body, timeout, content_type)


def export_product(body: Dict[str, Any], timeout: int = 30, content_type: str = "application/json") -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/product/export"
    return _put_or_patch(url, body, timeout, content_type)


def delete_product(code: str, timeout: int = 15) -> Dict[str, Any]:
    base = _base_url()
    url = f"{base}/v1/druginfo/product/{code}"
    resp = requests.delete(url, headers=_headers(), timeout=timeout)
    return _handle_response(resp)
